const Challenge = () => {
  return (
    <div className="m-4">
      <h1 className="flex gap-2 items-center justify-center font-bold text-center text-2xl">
        <svg
          ...
          strokeWidth={2}
          stroke="currentColor"
          className="w-10 h-10 text-blueDark"
        >
          <path
            strokeLinecap="round"
        ...
        <span className="text-blueDark">My Challenge</span>
      </h1>
      ...
      <div className="flex flex-col m-4 mt-6">
        <div className="flex gap-4">
          <div className="h-11 w-11 bg-yellow-700 flex justify-center items-center rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
      ...
      <div className="flex flex-col m-4 mt-6 grayscale opacity-80 ">
        <div className="flex gap-4">
          <div className="h-11 w-11 bg-green-700 flex justify-center items-center rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex flex-col">
            <p className="font-bold text-md text-green-700">
              ออกกำลังกาย 60 นาที 3 วัน
            </p>
            <p className="text-sm text-green-700">เหลืออีก 1 วันเท่านั้น !</p>
          </div>
        </div>
      </div>
    </div>
